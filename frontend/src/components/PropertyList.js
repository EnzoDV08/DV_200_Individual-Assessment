...
const PropertyList = () => {
  ...
  { _id: '1', title: 'Modern Family Home', price: 350000, location: 'Los Angeles, CA', imageUrl: 'https://barcarchitects.com/wp-content/uploads/2019/12/1-White-Oaks.jpg' },
    ...
    { _id: '17', title: 'Rustic Cabin', price: 350000, location: 'Asheville, NC', imageUrl: 'https://via.placeholder.com/400x300' },
    { _id: '18', title: 'Countryside Bungalow', price: 400000, location: 'Burlington, VT', imageUrl: 'https://via.placeholder.com/400x300' },
    { _id: '19', title: 'Urban Loft', price: 380000, location: 'Philadelphia, PA', imageUrl: 'https://via.placeholder.com/400x300' },
    { _id: '20', title: 'Lake House', price: 950000, location: 'Lake Tahoe, CA', imageUrl: 'https://via.placeholder.com/400x300' }
      ];
